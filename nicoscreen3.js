...
function nicoscreenobj3(o) {
  var f = nicoscreenobj3.f, i, len, n, prop;
  f.prototype = o;
  n = new f;
...
r3.NicoScreen = {
	...
	start : function(){
		...
		var inid = setInterval("nicoscreen3.draw(null)", this.env.interval);
...
var nicoscreen3 = nicoscreenobj3(r3.NicoScreen);
