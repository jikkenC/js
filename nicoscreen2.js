...
function nicoscreenobj2(o) {
  var f = nicoscreenobj2.f, i, len, n, prop;
  f.prototype = o;
  n = new f;
...
r2.NicoScreen = {
	...
	start : function(){
		...
		var inid = setInterval("nicoscreen2.draw(null)", this.env.interval);
...
var nicoscreen2 = nicoscreenobj2(r2.NicoScreen);
