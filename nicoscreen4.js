...
function nicoscreenobj4(o) {
  var f = nicoscreenobj4.f, i, len, n, prop;
  f.prototype = o;
  n = new f;
...
r4.NicoScreen = {
	...
	start : function(){
		...
		var inid = setInterval("nicoscreen4.draw(null)", this.env.interval);
...
var nicoscreen4 = nicoscreenobj4(r4.NicoScreen);
